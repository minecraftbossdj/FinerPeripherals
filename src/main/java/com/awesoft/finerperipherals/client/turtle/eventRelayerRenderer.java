...
public class eventRelayerRenderer implements TurtleUpgradeModeller<eventRelayerTurtle> {

    @Override
    public TransformedModel getModel(eventRelayerTurtle upgrade, ITurtleAccess turtle, TurtleSide side) {
        ...
        return TransformedModel.of(FinerPeripherals.EVENTRELAYER_BLOCK.asItem().getDefaultInstance(), new Transformation(matrix));
    }
}
